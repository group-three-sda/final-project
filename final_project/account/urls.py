...
urlpatterns = [
    ...
    path('password_change_form/', auth_views.PasswordChangeView.as_view(template_name='account/password_change_form.html', success_url=reverse_lazy('account:password-change')), name='password-change'),
